...
- [Optional feature gating](feedback_optional_feature_gating.md) — no opt-in flags/new extras; add dep to the existing extra + optional.py sentinel, always-on when importable
